...
<template>
  <div class="font-400">
    <div class="bg-secondary">
      <div class="flex items-center justify-start  m-x-auto max-w-[1400px]">
        <p class="flex-c-1">Photo</p>
        <p class="flex-c-2">Character ID</p>
        <p class="flex-c-3">Name</p>
        <p class="flex-c-2">Gender</p>
        <p class="flex-c-2">Species</p>
        <p class="flex-c-2">Last Episode</p>
        <p class="flex-c-2">Add to favourites</p>
      </div>
    </div>
   <div>
     <ul v-if="store.characterList" class="list-none m-x-auto max-w-[1400px] p-0">
       <li
       ...
       >
         ...
         <div class="flex-c-2">
           <button
               :disabled="store.isCharacterFavourite(character.id)"
